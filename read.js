...
// x.filter((a)=>{if(a.price>=25)console.log(a.title)})
// var arr=[];
// let y= x.filter((a) => a.category=='electronics').map((a)=>a.price);
    
// arr=y.sort((a,b)=>a-b)
// console.log(arr[0])

// let z = x.map((a) => a.description).join(", ");
// console.log(z);
// let z = x.filter((a)=>a.category=="women's clothing").reduce((n,a)=> {return a.price});console.log(z);
let z = x.filter((a)=>a.description.search("water")).filter((a)=>a.price>20);
console.log(z);